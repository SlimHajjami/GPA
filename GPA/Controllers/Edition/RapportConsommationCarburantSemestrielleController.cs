...
{
    public class RapportConsommationCarburantSemestrielleController : BaseController
    {
        public ActionResult Export(string type, int client, int annee, int mois)
        {
            try
            {
                ...
                string path = Path.Combine(Server.MapPath("~/Reports/Edition"), "RapportConsommationCarburantSemestrielle.rdlc");
                ...
                List<RapportConsommationCarburantSemestrielleModel> list = RapportConsommationCarburantSemestrielleService.Read(client, access, annee, mois);
                ...
                Response.AddHeader("content-disposition", "attachment; filename=consommation_carburant_semestrielle." + fileNameExtension);
